...
The function receives an array address and a numeric parameter, and then directly distributes the token to the address in the array, but there is no limit in the calculation, resulting in overflow.

![](media/15313078150750/15313089230631.jpg)

There are vulnerabilities in the two lines of code selected in the red box in the above figure.:[How to Secure Your Smart Contracts: 6 Solidity Vulnerabilities and how to avoid them](https://medium.com/loom-network/how-to-secure-your-smart-contracts-6-solidity-vulnerabilities-and-how-to-avoid-them-part-1-c33048d4d17d)
